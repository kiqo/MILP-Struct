...
public class AlgoTester {
	...
	public static void test( String typeName, NGraph<InputData> g ) throws InterruptedException {
	...
	void test( NGraph<InputData> g ) throws InterruptedException {
